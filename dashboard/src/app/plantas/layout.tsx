...
export default function PlantasLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-full flex flex-col" style={{ background: '#0c0700', color: '#fff' }}>
      <header style={{ background: '#0a0500', borderBottom: '1px solid #1f1000' }}
        className="sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-5 h-14 flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center"
              style={{ background: 'rgba(34,197,94,0.12)', border: '1px solid #2a1605' }}>
      ...
      <footer className="text-center text-xs py-4"
        style={{ color: '#2d1a0a', borderTop: '1px solid #1f1000' }}>
